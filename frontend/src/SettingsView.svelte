                    ...
                    <div class="max-w-2xl">
                        ...
                        <div class="space-y-5">
                            ...
                            {#if selectedSetting.id === "core-screenshot"}
                                <div
                                    class="p-4 bg-gradient-to-r from-blue-900/30 to-purple-900/30 border border-blue-700/50 rounded-lg"
                                >
                                            ...
                                            >
                                                ...
                                                <p>
                                                    <span
                                                        ...
                                                        >Webリクエスト</span
                                                    >の場合：画像をBase64エンコードしてJSONで送信
                                                </p>
                                                <p class="ml-4 text-gray-400">
                                                    → JSONフィールド: <code
                                                        class="px-1 py-0.5 bg-dark-300 rounded text-purple-300"
                                                        >image</code
                                                    >,
                                                    <code
                                                        class="px-1 py-0.5 bg-dark-300 rounded text-purple-300"
                                                    ...
                                                    >,
                                                    <code
                                                        class="px-1 py-0.5 bg-dark-300 rounded text-green-300"
                                                        >world_id</code
                                                    >,
                                                    <code
                                                        class="px-1 py-0.5 bg-dark-300 rounded text-green-300"
                                                ...
                                                <p class="mt-2">
                                                    <span
                                                        class="font-medium text-blue-300"
                                                        >Discord Webhook</span
                                                    >の場合：画像ファイルをマルチパートフォームで送信
                                                </p>
                                                <p class="ml-4 text-gray-400">
                                                    → 投稿文に<span
                                                        class="font-medium text-green-300"
