...
<div
    class="content flex flex-col gap-4 p-6 bg-dark-100 rounded-lg shadow-card flex-grow overflow-y-auto"
>
    <div class="flex items-center mb-2">
        <div
            class="flex-shrink-0 w-10 h-10 flex items-center justify-center bg-primary-700 rounded-md text-white mr-3"
        >
    ...
    <div class="grid grid-cols-1 gap-5">
        ...
        <div class="space-y-2">
            <label class="block text-sm font-medium text-gray-300" for="Details"
                >説明</label
            >
            <input
                id="Details"
